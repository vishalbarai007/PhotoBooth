    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link href="/setup" className="flex items-center gap-2 text-pink-600 self-start sm:self-auto">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8">
          ...
          <Link href={canProceed ? `/capture?layout=${layout}` : "#"} className="w-full sm:w-auto">
            <Button size="lg" disabled={!canProceed} className="w-full bg-pink-500 hover:bg-purple-700">
              Ready to Capture
